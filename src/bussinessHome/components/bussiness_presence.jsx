...
function Buss_presence() {
  return (
    ...
    <div className="presence_head">
        <h1 className="presence_h1"><span className="presence_span">FitBet </span> Presence</h1>
    </div>
    ...
    <div className="presence_india">
        ...
        <p className="presence_p">Bangalore | Mumbai | Hyderabad | NCR | Chennai | Pune | Kolkata | Mysore | Mangalore | Coimbatore | Kochi | Vizag | Jaipur |

Ahmedabad | Surat | Indore | Chandigarh | Amritsar | Ludhiana | Jammu |</p>
    </div>
    </div>
    </div>
