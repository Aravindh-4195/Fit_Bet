...
function Buss_trainer() {
  return (
    ...
    <div className="trainer_image"></div>
            ...
            <h2 className="trainer_h2"><span className="trainer_span">Personal</span> Trainer</h2>
            <p className="trainer_p">"Shape Your Future, Shape Theirs: Launch Your Career as a Personal Trainer"</p>
